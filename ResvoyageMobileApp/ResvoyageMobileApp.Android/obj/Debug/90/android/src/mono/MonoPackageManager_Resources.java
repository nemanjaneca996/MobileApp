...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "ResvoyageMobileApp.Android.dll" comes first in this list. */
		"ResvoyageMobileApp.Android.dll",
		"CreditCardValidator.dll",
		"FFImageLoading.dll",
		...
		"RedCorners.dll",
		"RedCorners.Forms.dll",
		"RestSharp.dll",
		"ResvoyageMobileApp.dll",
		...
		"LiveSharp.Runtime.dll",
		"LiveSharp.Interfaces.dll",
		"LiveSharp.ServerClient.dll",
		"LiveSharp.Support.XamarinForms.dll",
		"LiveXaml.Standard.dll",
	};
